  ...
  <div id="hero" class="min-h-screen flex flex-col bg-base-200">
    ...
    <section class="min-h-[95vh] flex items-center justify-center bg-base-200 px-6">
      <div class="max-w-4xl text-center animate-fade-in">
        ...
        <a href="#main-content" class="btn btn-primary btn-lg px-10">Start now</a>
      </div>
    </section>
    ...
    <!-- MAIN CONTENT -->
    <main id="main-content" class="grow container mx-auto px-4 py-8 min-h-screen flex flex-col justify-center gap-0">
