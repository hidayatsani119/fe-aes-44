...
<template>
  <div class="min-h-screen flex flex-col bg-base-200">
    ...
    <main id="main-content" class="grow container mx-auto px-4 py-8 min-h-screen flex flex-col justify-center">
      <div role="tablist" class="tabs tabs-box p-1 bg-base-100 mb-6 justify-center">
        <RouterLink to="/encrypt" role="tab" class="tab" active-class="tab-active">Encrypt</RouterLink>
        <RouterLink to="/decrypt" role="tab" class="tab" active-class="tab-active">Decrypt</RouterLink>
      </div>
