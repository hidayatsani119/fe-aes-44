...
<template>
  <div class="hero grow flex flex-col justify-center items-center">
    <div class="animate-fade-in">
      <form @submit.prevent="handleSubmit">
        <fieldset class="fieldset bg-base-100 shadow-lg rounded-box w-xs md:w-md lg:w-lg p-4 border border-info">
          ...
          <textarea placeholder="Secondary" class="textarea textarea-secondary" v-model="input.plaintext"></textarea>
    ...
    <div v-if="encryptedResult" class="card card-border bg-base-100 mt-5 border-info w-full">
      <div class="card-body">
