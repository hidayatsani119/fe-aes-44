  ...
  <div class="hero grow flex flex-col justify-center items-center">
    <div>
      <form @submit.prevent="handleSubmit">
        <fieldset class="fieldset flex flex-col justify-center rounded-box w-lg h-full border border-accent p-4">
          ...
          <input type="text" class="input w-full bg-transparent" placeholder="Secret Key" v-model="input.key" />
