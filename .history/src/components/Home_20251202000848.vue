...
<template>
  <div class="grow">
    <div class="hero flex justify-between items-center px-30">
      <div class="hero-content text-neutral-content animate-fade-in">
        <div class="max-w-md">
          <h1 class="text-5xl font-bold">Lorem, ipsum dolor.</h1>
          <p class="py-6">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ab quaerat dolore cum fugiat iste iusto doloremque
            quis nam rerum aspernatur?
          </p>
          <button class="btn btn-primary">Lorem.</button>
        </div>
      </div>
      <div class="mockup-phone scale-65">
        <div class="mockup-phone-camera"></div>
        <div class="mockup-phone-display">
          <img
            alt="wallpaper"
            src="https://images.unsplash.com/photo-1619777709778-f2629bc94a6c?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          />
        </div>
      </div>
    </div>
    <div class="card lg:card-side shadow-sm px-30 mb-30">
      ...
      <div class="card-body">
        <h2 class="card-title">What is AES SBOX?</h2>
        <p>
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Doloribus natus omnis <br />similique placeat et
          impedit Lorem ipsum dolor sit amet consectetur adipisicing elit. Vero, minima. Lorem <br />ipsum dolor sit
          amet consectetur adipisicing elit. Voluptatum, quis.
        </p>
    ...
    <div class="px-30 mb-30">
      <h1 class="text-5xl text-neutral-content text-center font-bold mb-10">Lorem ipsum dolor sit amet.</h1>
    ...
    <div class="flex flex-row px-30 gap-50 mb-30">
      <div class="flex flex-col justify-center">
        <h1 class="text-3xl text-info font-bold mb-5">Lorem, ipsum dolor.</h1>
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi eaque fugit quod earum ab pariatur, culpa
          suscipit debitis voluptas aspernatur quia adipisci odio. Quis vel quae ab possimus corporis unde.
        </p>
      </div>
  ...
  <!-- <div class="justify-center items-center px-30"></div> -->
</template>
