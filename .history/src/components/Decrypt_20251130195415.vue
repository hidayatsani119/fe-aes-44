  ...
  <div class="hero grow flex flex-col justify-center items-center">
    <div>
      <form @submit.prevent="handleSubmit">
        <fieldset
          class="fieldset flex flex-col justify-center rounded-box bg-neutral w-lg h-full border border-accent p-4"
        >
          ...
          <input
            type="text"
            class="input input-neutral-content w-full bg-transparent text-info"
